...
**Validation**: Every user story MUST include the cheapest validation that proves
it works independently. Automated tests are REQUIRED when specified by the
feature, or when the story changes contracts, decision-support behavior, tenant
boundaries, or critical data handling.

**Organization**: Tasks are grouped by user story to enable independent
implementation and testing of each story. Sequence the smallest shippable MVP
slice before any expansion or enterprise-only work.
...
- Include trust, auditability, isolation, and observability tasks whenever the
  story touches people decisions or sensitive tenant data
...
**Purpose**: Project initialization and only the shared infrastructure needed for
the MVP slice

- [ ] T001 Create project structure per implementation plan
- [ ] T002 Initialize [language] project with [framework] dependencies
- [ ] T003 [P] Configure linting and formatting tools
- [ ] T004 [P] Establish baseline logging and runtime configuration
...
Only include prerequisites here when they block every MVP story. Defer future-tier
or enterprise-only infrastructure unless the plan marks it as a constitutional
requirement.
...
- [ ] T009 Configure error handling and observability infrastructure
- [ ] T010 Setup environment and tenant-configuration management
- [ ] T011 Add audit trail or decision-event foundations if the feature affects
  people-impacting outputs
...
- [ ] T019 [US1] Add logging, auditability, and access-control handling as needed
...
- [ ] TXXX Verify auditability, isolation, and observability expectations remain met
...
- Automated tests, when included or required, MUST be written and FAIL before implementation
...
```bash
# Launch all automated tests for User Story 1 together (when they apply):
